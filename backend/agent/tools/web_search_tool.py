...
class SandboxWebSearchTool(SandboxToolsBase):
    ...
    @xml_schema(
        ...
        <parameter name="query">what is Heeddata AI and what are they building?</parameter>
    ...
    @xml_schema(
        ...
        <parameter name="urls">https://www.heeddata.com/,https://github.com/heeddata/suna</parameter>
        </invoke>
        </function_calls>
        '''
    )
