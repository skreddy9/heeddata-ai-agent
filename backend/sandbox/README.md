...
2. Build a custom image:
   ...
   docker push heeddata/ai-agent:0.1.3
   ```
...
1. Change the `image` parameter in `docker-compose.yml` (that defines the image name `heeddata/ai-agent:___`)
...
3. Push the new version: `docker push heeddata/ai-agent:0.1.3`
