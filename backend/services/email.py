...
class EmailService:
    def __init__(self):
        ...
        self.sender_email = os.getenv('MAILTRAP_SENDER_EMAIL', 'dom@heeddata.com')
        self.sender_name = os.getenv('MAILTRAP_SENDER_NAME', 'AI Agent Team')
    ...
    def send_welcome_email(self, user_email: str, user_name: Optional[str] = None) -> bool:
        ...
        subject = "🎉 Welcome to AI Agent — Let's Get Started "
...
<head>
  ...
  <title>Welcome to Heeddata AI Agent</title>
  <style>
    body {{
...
<body>
  <div class="container">
    <div class="logo-container">
      <img src="https://i.postimg.cc/WdNtRx5Z/kortix-suna-logo.png" alt="Heeddata AI Agent Logo" class="logo">
    </div>
    <h1>Welcome to Heeddata AI Agent!</h1>

    <p>Hi {user_name},</p>

    <p><em><strong>Welcome to Heeddata AI Agent — we're excited to have you on board!</strong></em></p>
    ...
    <p>To celebrate your arrival, here's a <strong>15% discount</strong> to try out the best version of AI Agent (1 month):</p>
    ...
    <p>Thanks again, and welcome to the AI Agent community <span class="emoji">🌞</span></p>

    <p>— The AI Agent Team</p>

    <a href="https://www.heeddata.com/" class="button">Go to the platform</a>
  </div>
</body>
</html>"""
...
Welcome to AI Agent — we're excited to have you on board!
...
To celebrate your arrival, here's a 15% discount to try out the best version of AI Agent (1 month):
...
Thanks again, and welcome to the AI Agent community 🌞

— The AI Agent Team

Go to the platform: https://www.heeddata.com/

---
© 2024 AI Agent. All rights reserved.
You received this email because you signed up for a AI Agent account."""
