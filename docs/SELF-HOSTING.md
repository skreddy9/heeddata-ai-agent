# AI Agent Self-Hosting Guide

This guide provides detailed instructions for setting up and hosting your own instance of AI Agent, an open-source generalist AI agent.
...
```bash
git clone https://github.com/heeddata/suna.git
cd suna
```
...
- Start AI Agent using your preferred method
...
3. Create a Docker image:
   - Image name: `heeddata/ai-agent:0.1.3`
...
AI Agent can be started in two ways:
...
For further assistance, join the [AI Agent Discord Community](https://discord.gg/Py6pCBUUPw) or check the [GitHub repository](https://github.com/heeddata/suna) for updates and issues.
