...
export default function ThreadPage({
  ...
  useEffect(() => {
    if (projectName) {
      document.title = `${projectName} | Heeddata AI Agent`;
      ...
      if (metaDescription) {
        metaDescription.setAttribute(
          'content',
          `${projectName} - Interactive agent conversation powered by Heeddata AI Agent`,
        );
      }

      const ogTitle = document.querySelector('meta[property="og:title"]');
      if (ogTitle) {
        ogTitle.setAttribute('content', `${projectName} | Heeddata AI Agent`);
      }
        ...
        <div
          ...
          <div className={cn(
            ...
            <ChatInput
              ...
              placeholder={`Ask ${agent ? agent.name : 'AI Agent'} anything...`}
              loading={isSending}
