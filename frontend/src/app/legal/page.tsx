                ...
                {activeTab === 'terms' ? (
                  <div>
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      ...
                      CAREFULLY BEFORE USING THE SERVICES OFFERED BY Heeddata AI
                    ...
                    <ul className="text-muted-foreground space-y-1 mb-6">
                      <li>
                        "Company" refers to Heeddata AI Corp (701 Tillery Street
                        Unit 12-2521 Austin, Texas 78702, United States).
                      </li>
                      <li>
                        "Site" refers to the AI Agent website, including any related
                        features, content, or applications offered from time to
                        time by the Company.
                      </li>
                      <li>
                        "Service" refers to the AI Agent website and all related
                      ...
                      <li>
                        ...
                        Company, specifically legal@heeddata.com
                      </li>
                      <li>
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      AI Agent is licensed under the Apache License, Version 2.0.
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      ...
                      please write to legal@heeddata.com and we will process and
                    ...
                    <p className="text-muted-foreground text-balance mb-4">
                      ...
                      or by emailing us at legal@heeddata.com. If you cancel
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      All AI Agent logos, marks, and designations are trademarks or
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      ...
                      by emailing us at{' '}
                      <a
                        href="mailto:legal@heeddata.com"
                        className="text-secondary hover:underline"
                      >
                        legal@heeddata.com
                      </a>
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      References to our "Services" at AI Agent in this statement
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      AI Agent does not collect biometric or identifying
