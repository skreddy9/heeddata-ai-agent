...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  const fallbackMetaData = {
    title: 'Shared Conversation | Heeddata AI Agent',
    description: 'Replay this Agent conversation on Heeddata AI Agent',
    alternates: {
  ...
  try {
    ...
    const title = projectData.name || 'Shared Conversation | Heeddata AI Agent';
    const description =
      projectData.description ||
      'Replay this Agent conversation on Heeddata AI Agent';
